var RegType = exports.RegType = function RegType(/* ... */) {
  this.serviceType = '';
  this.protocol = '';
  this.subtypes = [];
...
RegType.wildcard = '_services._dns-sd._udp.';
RegType.prototype.isWildcard = function isWildcard() {
  return this.toString() === RegType.wildcard;
}
...
RegType.prototype.fromString = function fromString(string) {
  var is_wildcard = string === RegType.wildcard
