...
THIS IS A FORK OF "agnat/node_mdns":https://github.com/agnat/node_mdns WITH ADDITIONAL PATCHES.
THE MOMENT agnat/node_mdns BECOMES ACTIVE AGAIN, WE WILL SYNC UP AND REMOVE THIS REPOSITORY.
...
|_. Version:       | 2.1.0 |
|_. Installation:  | @npm install mdns2@ (see below) |
...
bc. git clone http://github.com/Wizcorp/node_mdns
cd node_mdns
npm link && npm test
...
, "dependencies":
  { "mdns": "https://github.com/Wizcorp/node_mdns/tarball/master"
  }
}
